...
Pipeline 和 `Jenkinsfile` 的更多相关信息，请参考用户手册中的相关链接 link:/zh/doc/book/pipeline[Pipeline] 和
link:/zh/doc/book/pipeline/jenkinsfile[使用 Jenkinsfile]

快速开始使用 Pipeline：

. 将<<examples,以下示例>> 复制到您的仓库中并命名为 `Jenkinsfile`
...
**link:../running-multiple-steps[继续学习 "执行多个步骤"]**
...
---
**link:../running-multiple-steps[继续学习“运行多重步骤 steps”]**
